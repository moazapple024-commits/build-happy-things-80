...
export function FloatingReserve() {
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-40 flex items-center gap-2 rounded-full bg-gold px-6 py-3.5 text-sm text-primary-foreground shadow-[0_20px_60px_-15px_oklch(0.78_0.14_78_/_0.6)] transition-all hover:scale-105"
    >
